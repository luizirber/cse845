...
TestWizard::genesisTypePageSetup(QWidget *page){
  Message("<TestWizard::genesisTypePageSetup>");
...
TestWizard::genesisTypePageValidator(QWidget *page){
  Message("<TestWizard::genesisTypePageValidator>");
...
TestWizard::existingGenesisSelectPageSetup(QWidget *page){
  Message("<TestWizard::existingGenesisSelectPageSetup>");
    ...
    if(ok){
      if(strval != QString::null){
        if(genesis_fileinfo.exists()){
          ...
          } else Message(" --- !genesis_fileinfo.isReadable()");
        } else Message("! --- genesis_fileinfo.exists()");
      } else Message(" --- strval == QString::null");
    } else Message(" --- bad key:  GENESIS_PATH");
        ...
        if(working_dirinfo.exists()){
          if(working_dirinfo.isDir()){
            if(working_dirinfo.isReadable()){
              ...
              } else Message(" --- !working_dirinfo.isWritable()");
            } else Message(" --- !working_dirinfo.isReadable()");
          } else Message(" --- !working_dirinfo.isDir()");
        } else Message(" --- !working_dirinfo.exists()");
      } else Message(" --- strval == QString::null");
    } else Message(" --- bad key:  DEFAULT_DIR");
...
{
  Message("<TestWizard::existingGenesisSelectPageValidator>");
  ...
  if(inst_set_fileinfo.isRelative()){
    Message(" --- inst_set_fileinfo.isRelative()");
  ...
  if(start_creature_fileinfo.isRelative()){
    Message(" --- start_creature_fileinfo.isRelative()");
  ...
  if(event_file_fileinfo.isRelative()){
    Message(" --- event_file_fileinfo.isRelative()");
  ...
  if(environment_fileinfo.isRelative()){
    Message(" --- environment_fileinfo.isRelative()");
  ...
  Message(" --- done, happy.  current directory:  ")(QDir::currentDirPath());
...
TestWizard::setupStylePageSetup(QWidget *page){
  Message("<TestWizard::setupStylePageSetup>");
...
TestWizard::setupStylePageValidator(QWidget *page){
  Message("<TestWizard::setupStylePageValidator>");
...
TestWizard::modifyGenesisSelectPageSetup(QWidget *page){
  Message("<TestWizard::modifyGenesisSelectPageSetup>");
...
{
  Message("<TestWizard::modifyGenesisSelectPageValidator>");
...
TestWizard::simpleTopologyPageSetup(QWidget *page){
  Message("<TestWizard::simpleTopologyPageSetup>");
...
TestWizard::simpleTopologyPageValidator(QWidget *page){
  Message("<TestWizard::simpleTopologyPageValidator>");
...
TestWizard::simple2dSizePageSetup(QWidget *page){
  Message("<TestWizard::simple2dSizePageSetup>");
...
TestWizard::simple2dSizePageValidator(QWidget *page){
  Message("<TestWizard::simple2dSizePageValidator>");
...
TestWizard::simpleWellmixedSizePageSetup(QWidget *page){
  Message("<TestWizard::simpleWellmixedSizePageSetup>");
...
TestWizard::simpleWellmixedSizePageValidator(QWidget *page){
  Message("<TestWizard::simpleWellmixedSizePageValidator>");
...
TestWizard::simplePopulatePageSetup(QWidget *page){
  Message("<TestWizard::simplePopulatePageSetup>");
    ...
    if(ok){
      if(strval != QString::null){
        if(start_creature_fileinfo.exists()){
          ...
          } else Message(" --- !start_creature_fileinfo.isReadable()");
        } else Message("! --- start_creature_fileinfo.exists()");
      } else Message(" --- strval == QString::null");
    } else Message(" --- bad key:  START_CREATURE");
...
TestWizard::simplePopulatePageValidator(QWidget *page){
  Message("<TestWizard::simplePopulatePageValidator>");
  ...
  Message(" --- FIXME:  injectmethod stuff not yet implemented.");
...
TestWizard::simpleEndconditionPageSetup(QWidget *page){
  Message("<TestWizard::simpleEndconditionPageSetup>");
...
TestWizard::simpleEndconditionPageValidator(QWidget *page){
  Message("<TestWizard::simpleEndconditionPageValidator>");
  ...
  Message(" --- max_gen, max_update okay");
...
TestWizard::simpleEnvironmentPageSetup(QWidget *page){
  Message("<TestWizard::simpleEnvironmentPageSetup>");
    ...
    if(ok){
      if(strval != QString::null){
        if(fileinfo.exists()){
          ...
          } else Message(" --- !fileinfo.isReadable()");
        } else Message("! --- fileinfo.exists()");
      } else Message(" --- strval == QString::null");
    } else Message(" --- bad key:  ENVIRONMENT_FILE");
...
TestWizard::simpleEnvironmentPageValidator(QWidget *page){
  Message("<TestWizard::simpleEnvironmentPageValidator>");
...
TestWizard::detailedEndconditionPageSetup(QWidget *page){
  Message("<TestWizard::detailedEndconditionPageSetup>");
...
TestWizard::detailedEndconditionPageValidator(QWidget *page){
  Message("<TestWizard::detailedEndconditionPageValidator>");
...
TestWizard::detailedWorldsizePageSetup(QWidget *page){
  Message("<TestWizard::detailedWorldsizePageSetup>");
...
TestWizard::detailedWorldsizePageValidator(QWidget *page){
  Message("<TestWizard::detailedWorldsizePageValidator>");
...
TestWizard::detailedCPUThreadsPageSetup(QWidget *page){
  Message("<TestWizard::detailedCPUThreadsPageSetup>");
...
TestWizard::detailedCPUThreadsPageValidator(QWidget *page){
  Message("<TestWizard::detailedCPUThreadsPageValidator>");
...
TestWizard::detailedRandomseedPageSetup(QWidget *page){
  Message("<TestWizard::detailedRandomseedPageSetup>");
...
TestWizard::detailedRandomseedPageValidator(QWidget *page){
  Message("<TestWizard::detailedRandomseedPageValidator>");
...
TestWizard::detailedFilepathsPageSetup(QWidget *page){
  Message("<TestWizard::detailedFilepathsPageSetup>");
    ...
    if(ok){
      if(strval != QString::null){
        if(fileinfo.exists()){
          ...
          } else Message(" --- !inst fileinfo.isReadable()");
        } else Message("! --- inst fileinfo.exists()");
      } else Message(" --- inst strval == QString::null");
    } else Message(" --- bad key:  INST_SET");
  }
  {
    ...
    if(ok){
      if(strval != QString::null){
        if(fileinfo.exists()){
          ...
          } else Message(" --- !event fileinfo.isReadable()");
        } else Message("! --- event fileinfo.exists()");
      } else Message(" --- event strval == QString::null");
    } else Message(" --- bad key:  EVENT_FILE");
  }
  {
    strval = m_current_genwrap->qStringValue("ENVIRONMENT_FILE", ok);
    QFileInfo fileinfo(strval);
    if(ok){
      if(strval != QString::null){
        if(fileinfo.exists()){
          ...
          } else Message(" --- !env fileinfo.isReadable()");
        } else Message("! --- env fileinfo.exists()");
      } else Message(" --- env strval == QString::null");
    } else Message(" --- bad key:  ENVIRONMENT_FILE");
  }
  {
    strval = m_current_genwrap->qStringValue("START_CREATURE", ok);
    ...
    if(ok){
      if(strval != QString::null){
        if(fileinfo.exists()){
          ...
          } else Message(" --- !organism fileinfo.isReadable()");
        } else Message("! --- organism fileinfo.exists()");
      } else Message(" --- organism strval == QString::null");
    } else Message(" --- bad key:  START_CREATURE");
  }
...
TestWizard::detailedFilepathsPageValidator(QWidget *page){
  Message("<TestWizard::detailedFilepathsPageValidator>");
...
TestWizard::detailedBirthsPageSetup(QWidget *page){
  Message("<TestWizard::detailedBirthsPageSetup>");
...
TestWizard::detailedBirthsPageValidator(QWidget *page){
  Message("<TestWizard::detailedBirthsPageValidator>");
...
TestWizard::detailedDeathsPageSetup(QWidget *page){
  Message("<TestWizard::detailedDeathsPageSetup>");
...
TestWizard::detailedDeathsPageValidator(QWidget *page){
  Message("<TestWizard::detailedDeathsPageValidator>");
  ...
  Message(" --- age_limit, age_deviation okay");
...
TestWizard::detailedDivrestrictionsPageSetup(QWidget *page){
  Message("<TestWizard::detailedDivrestrictionsPageSetup>");
...
TestWizard::detailedDivrestrictionsPageValidator(QWidget *page){
  Message("<TestWizard::detailedDivrestrictionsPageValidator>");
  ...
  // FIXME:  REQUIRED_TASK
  Message(" --- child_size_range, min_copied_lines, min_exe_lines okay");
...
TestWizard::detailedExemutationsPageSetup(QWidget *page){
  Message("<TestWizard::detailedExemutationsPageSetup>");
...
TestWizard::detailedExemutationsPageValidator(QWidget *page){
  Message("<TestWizard::detailedExemutationsPageValidator>");
...
TestWizard::detailedDivmutationsPageSetup(QWidget *page){
  Message("<TestWizard::detailedDivmutationsPageSetup>");
...
TestWizard::detailedDivmutationsPageValidator(QWidget *page){
  Message("<TestWizard::detailedDivmutationsPageValidator>");
...
TestWizard::detailedReversionsPageSetup(QWidget *page){
  Message("<TestWizard::detailedReversionsPageSetup>");
...
TestWizard::detailedReversionsPageValidator(QWidget *page){
  Message("<TestWizard::detailedReversionsPageValidator>");
...
TestWizard::detailedTimeslicingPageSetup(QWidget *page){
  Message("<TestWizard::detailedTimeslicingPageSetup>");
...
TestWizard::detailedTimeslicingPageValidator(QWidget *page){
  Message("<TestWizard::detailedTimeslicingPageValidator>");
...
TestWizard::detailedMeritsizePageSetup(QWidget *page){
  Message("<TestWizard::detailedMeritsizePageSetup>");
...
TestWizard::detailedMeritsizePageValidator(QWidget *page){
  Message("<TestWizard::detailedMeritsizePageValidator>");
...
TestWizard::detailedMerittasksPageSetup(QWidget *page){
  Message("<TestWizard::detailedMerittasksPageSetup>");
...
TestWizard::detailedMerittasksPageValidator(QWidget *page){
  Message("<TestWizard::detailedMerittasksPageValidator>");
...
TestWizard::detailedGenotypeinfoPageSetup(QWidget *page){
  Message("<TestWizard::detailedGenotypeinfoPageSetup>");
...
TestWizard::detailedGenotypeinfoPageValidator(QWidget *page){
  Message("<TestWizard::detailedGenotypeinfoPageValidator>");
...
TestWizard::detailedSpeciesinfoPageSetup(QWidget *page){
  Message("<TestWizard::detailedSpeciesinfoPageSetup>");
...
TestWizard::detailedSpeciesinfoPageValidator(QWidget *page){
  Message("<TestWizard::detailedSpeciesinfoPageValidator>");
...
TestWizard::detailedLogfilesPageSetup(QWidget *page){
  Message("<TestWizard::detailedLogfilesPageSetup>");
  ...
  QString strval;
    ...
    if(ok) m_detailed_log_geneology_cb->setCurrentItem(
        m_log_geneology_map.cbindex(intval)
      );
    else Message(" --- ");
...
TestWizard::detailedLogfilesPageValidator(QWidget *page){
  Message("<TestWizard::detailedLogfilesPageValidator>");

  QString result = QString::null;

  m_current_genwrap->set(
    "LOG_GENOTYPES",
    m_log_geneology_map.filechoice(
      m_detailed_log_geneology_cb->currentItem()
    )
  );
  m_current_genwrap->set(
    "LOG_MUTATIONS",
...
TestWizard::newSavegenesisPageSetup(QWidget *page){
  Message("<TestWizard::newSavegenesisPageSetup>");
...
TestWizard::newSavegenesisPageValidator(QWidget *page){
  Message("<TestWizard::newSavegenesisPageValidator>");
...
TestWizard::modifiedSavegenesisPageSetup(QWidget *page){
  Message("<TestWizard::modifiedSavegenesisPageSetup>");
...
TestWizard::modifiedSavegenesisPageValidator(QWidget *page){
  Message("<TestWizard::modifiedSavegenesisPageValidator>");
