...
public:
  ...
  void Inst_Nop();  // A no-operation instruction that does nothing! 
  ...
  virtual void SingleProcess(ostream * trace_fp=NULL) = 0;
  ...
  // --------  Input and Output --------
  virtual void PrintStatus(ostream & fp) = 0;
  virtual void SaveState(ostream & fp) = 0;
  virtual void LoadState(istream & fp) = 0;
