...
public:
  static void Setup(cInstLib * in_inst_lib,  cEnvironment * in_env,
		    const cPopulationInterface & in_interface);
  static void SetInstLib(cInstLib * in_inst_lib);
  ...
  static cInstLib * GetInstLib() { return inst_lib; }
